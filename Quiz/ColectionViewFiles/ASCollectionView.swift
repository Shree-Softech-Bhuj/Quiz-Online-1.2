...
@objcMembers public class ASCollectionView: UICollectionView, UICollectionViewDataSource {
    ...
    private func setUp() {
      ...
      //  NotificationCenter.default.addObserver(self, selector: #selector(ASCollectionView.orientationChanged(_:)), name: UIDevice.NSNotification.Name.UIDeviceOrientationDidChange, object: nil)

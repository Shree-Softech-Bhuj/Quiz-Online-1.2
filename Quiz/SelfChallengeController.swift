...
class SelfChallengeController: UIViewController {
    ...
    @IBAction func PlayAction(_ sender: Any) {
        ...
        let viewCont = storyboard.instantiateViewController(withIdentifier: "SelfChallenegePlay") as! SelfChallengePlay
...
extension SelfChallengeController:UIPickerViewDataSource,UIPickerViewDelegate{
    ...
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        if pickerView == self.mainPicker{
            ...
            return self.subCatData[row].name + "     Ques : \(self.subCatData[row].noOf)"
        }
    }

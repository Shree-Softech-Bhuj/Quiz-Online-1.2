...
//        self.tableView.layer.cornerRadius = 10
     /*   self.playButton.layer.cornerRadius = 10
        ...
        self.ref = Database.database().reference().child(gameRoomCode)//(Apps.ROOM_NAME)
...
//            let refR = Database.database().reference().child(gameRoomCode).child(self.roomInfo!.roomFID).child("joinUser").child(currUser.UID)
